// Script que se ejecuta automáticamente en todas las páginas para agregar el panel de debug
(function() {
    'use strict';
    
    // Solo ejecutar si no existe ya el panel global
    if (document.getElementById('global-debug-panel')) return;
