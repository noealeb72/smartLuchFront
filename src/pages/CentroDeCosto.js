...
const MANUAL_CENTROS_COSTO = [
  {
    tipo: 'parrafo',
    texto:
      'El centro de costo es la unidad contable a la que se le imputa el consumo de un usuario, para ' +
      'que administración pueda distribuir el gasto de comedor entre áreas de la empresa.',
  },
  { tipo: 'subtitulo', texto: 'Campos' },
  {
    ...
    body: [
      ...
      ['Planta', 'Comedor al que pertenece (se autoselecciona si solo hay una planta cargada)'],
  ...
  { tipo: 'subtitulo', texto: 'Dónde se usa' },
  {
    ...
    items: [
      ...
      'Se asigna también a cada Proyecto.',
      'Aparece en los reportes de gestión y facturación para agrupar consumos por centro de costo.',
    ],
  },
  { tipo: 'subtitulo', texto: 'Cómo administrar' },
  {
    ...
    items: [
      ...
      'El centro de costo "predeterminado" se marca desde el listado con el botón de estrella, no desde el formulario.',
    ],
  },
];
  ...
  return (
    <div className="container-fluid" style={{ padding: 0 }}>
      ...
      <div className="page-title-bar" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <BotonAyuda titulo="Manual — Centros de Costo" contenido={MANUAL_CENTROS_COSTO} nombreArchivo="manual_centros_costo.pdf" />
      </div>
